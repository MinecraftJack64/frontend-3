                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        ...
                        if (formKey.currentState!.validate()) {
                          ...
                          doTheThing(appState, userc.text, passc.text, nickc.text, nick2c.text);
                        }
                      },
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> changeThreshold(MyAppState s, timec)async{
    int result = 0;//await s.addReading(timec, valc, mealc, methc, commc);
    if(result==200){
      setState((){
        needsupdate = true;
      });
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            if (formKey.currentState!.validate()) {
                              //_formKey.currentState.save();
                              changeThreshold(appState, userc.text);
                            }
                          },
